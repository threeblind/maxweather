...
- 第10区: 113km / 1055km"""
    ...
    def build_user_prompt(self):
        ...
        prompt_parts = [
            ...
            "- 見出しは最低4個とし、必要なら5個以上でも良い",
            "- 見出しは『独走』『混戦』『今日の総括』のような抽象語だけで済ませず、何が起きたかが一読で分かる具体的な文にすること。",
            ...
            "- 選手名の先頭に数字が付いている場合（例: 1甲佐、2岱明）、出力時はその数字を必ず削除して名前のみ（例: 甲佐君、岱明君）にすること。",
            ...
            "- 最後は必ず『今日の総括』という見出しを立て、その日の全体像を短く締めること。",
        ...
        prompt_parts.append(
            ...
            "# 出力形式\n"
            "- 1行目はタイトルを『# 』で始めること。\n"
            "- 2行目以降は、本日のレース全体を象徴するメイン見出しを『### 』で1つ書くこと。\n"
            "- その下に、各トピックの小見出しを『#### 』で3〜4個書き、それぞれに本文を続けること。\n"
            "- 最後の小見出しは必ず『#### 今日の総括』にすること。\n"
            "- 各見出し・小見出しは、その段落の要点がすぐ伝わる具体的な文言にすること。\n"
            "- 過剰な箇条書きは使わない。\n"
